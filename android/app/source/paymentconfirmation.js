...
import * as PaymentsActions from './paymentreducer';
...
render() 
{
    return (
        <View>
            ...
            <Text style={{ margin: 20 }}>Thank you for buying with us. We sent you an email with the
confirmation details and an invoice.Here you can find a summary ofyour purchase:{' '}</Text>
...
function mapStateActionsToProps(dispatch) 
{
    ...
    Object.assign({}, PaymentsActions, ProductActions, UserActions),dispatch,);
}
